...
"  -Q, --hidesst              do not display the SST window\n"
...
while (1)
        ...
        c = getopt_long (argc, argv, "zf:Fon:a:AU:r:dl:s:e:c:t:NS:vVhxX:MD:IgCLR:P:O:QWT:1:2:3", long_options,
&option_index);
...
if (cmdserver_port != -1) 
	{
	tcl_command_server_init(cmdserver_port);
	}
